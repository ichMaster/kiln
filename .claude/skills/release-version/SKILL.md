...
- `/release-version 1.1.0 Tick-server scaffold; agent_id-scoped sessions` -- bump with provided changelog items
...
3. Summarize the changes into concise bullet points (group related commits; reference the kiln phase `vA.B` where relevant)
...
- **Don't modify source files.** This skill only touches version metadata (VERSION, README.md, RELEASE.txt), never engine/module/server/client code.
